...
{
    public sealed record ProductProfitabilityReportsQuery() 
        : IRequest<Result<List<ProductProfitabilityReportsQueryResponse>>>;
    ...
    internal sealed class ProductProfitabilityReportsQueryHandler(
        ...
        : IRequestHandler<ProductProfitabilityReportsQuery, Result<List<ProductProfitabilityReportsQueryResponse>>>
    {
